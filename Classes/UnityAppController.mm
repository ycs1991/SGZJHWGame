...
- (BOOL)application:(UIApplication*)app openURL:(NSURL*)url options:(NSDictionary<NSString*, id>*)options
{
    ...
    [[FBSDKApplicationDelegate sharedInstance] application:app openURL:url options:options]; return YES;
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    NSString *appToken = @"hn7k8o0y8x6o";

    NSString *environgment = ADJEnvironmentSandbox;

    ADJConfig *config = [ADJConfig configWithAppToken:appToken environment:environgment];
...
-(void) ShareFb
{
    ...
    [FBSDKShareDialog showFromViewController:[self sanguo_decisionClassificationRab_sanguo]
                                  withContent:content
                                     delegate:nil];
}
